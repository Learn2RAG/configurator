...
def build_router(import_config: Mapping[str, Any], login_handler: Callable[[Request, str, str], None], logout_handler: Callable[[Request, str], None]) -> APIRouter:
    router = APIRouter()
    ...
    '''
    router.auth_routers: dict[str, AuthImplRouter] = {
